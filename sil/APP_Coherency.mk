###########################################################################
## Makefile generated for component 'APP_Coherency'. 
## 
## Makefile     : APP_Coherency.mk
## Generated on : Sun Mar 09 07:20:11 2025
...
COMPILER_COMMAND_FILE     = APP_Coherency_comp.rsp
...
MODELREF_LIBS = ../APP_Coherency.obj

LIBS = $(START_DIR)/APP_Coherency_ert_rtw/coderassumptions/lib/APP_Coherency_ca.lib
...
sil_main.obj : $(START_DIR)/APP_Coherency_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
